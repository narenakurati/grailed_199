...
collected_data_reorder$interval[which(collected_data_reorder$sold_at <= (collected_data_reorder$sold_at[1] + i*x*60*60))] <- i

collected_data_reorder$sold_at[400] <= (collected_data_reorder$sold_at[1] + i*x*60*60)
